...
if __name__ == "__main__":
    ...
    number_linked_list1 = NumberLinkedList(617)
    number_linked_list2 = NumberLinkedList(295)
    result_linked_list = number_linked_list1 + number_linked_list2
    result = result_linked_list.as_number()
    print(result)
